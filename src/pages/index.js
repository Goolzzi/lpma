      ...
      case 2:
        ...
        setTimeout(() => {
          this.animationClasses[3].rightSpinner =
            "rotateTo180 show animation-delay-2";
          this.animationClasses[3].leftSpinner =
            "spinOuterIn animation-delay-3";
          this.animationClasses[3].leftInnerSpinner =
            "spinInnerIn animation-delay-3";
          this.animationClasses[3].fullLeftSpinner =
            "spinOuterIn show animation-delay-3";
      ...
      case 6:
        ...
        setTimeout(() => {
          ...
          this.animationClasses[10].fullLeftSpinner =
            "spinOuterIn show animation-delay-2";
          this.animationClasses[10].rightSpinner =
            "rotateTo180 show animation-delay-1";
          this.animationClasses[10].leftSpinner =
            "spinOuterIn animation-delay-2";
          this.animationClasses[10].leftInnerSpinner =
            "spinInnerIn animation-delay-2";
            ...
            <div className="full-right">
              ...
              <div className={`tutor-wrapper ${this.animationClasses[5]}`}>
                <div className="wrapper">
                  ...
                  <p>
                    It's not just about how hard you work, it's about how unique
                    your offer is. Our studies show that Investors are looking
                    for differentiation and are more likely to take their
                    business elsewhere. The landscape is more competitive than
                    ever and now is your chance to better understand the truth
              ...
              <div className="pricing-box">
                ...
                <div className="terms-container">
                  <div>
                    ...
                    <div className="terms-item">
                      <img src={icTick} />
                      <p>Invitiation to the LPMA Group Forum</p>
                    </div>
                    <div className="terms-item">
                      <img src={icTick} />
                      <p>
                ...
                <div className="submit-btn" onClick={() => this.joinUs()}>
                  JOIN LPMA
                </div>
              </div>
            </div>
