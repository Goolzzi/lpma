  ...
  <section className="section resources">
    ...
    <div className="columns is-multiline">
      <div className="column is-4-desktop is-6-tablet is-12-mobile resource-item">
        ...
        <p>Our popular, attention-grabbing stickers can help denote your agency as an LPMA member to your patrons. Contact us below to set up a delivery.</p>
      ...
      <div className="column is-4-desktop is-6-tablet is-12-mobile resource-item">
        ...
        <p>Proudly display your LPMA difference. Insert LPMA branding on your stationery and business cards to elevate your point of difference.</p>
        <div className="image is-16by9">
      ...
      <div className="column is-4-desktop is-6-tablet is-12-mobile resource-item">
        ...
        <p>Add your LPMA membership distinction to your emails, social media pages and website with our digital LPMA member badges.</p>
        <div className="image is-16by9">
      ...
      <div className="column is-4-desktop is-6-tablet is-12-mobile resource-item">
        ...
        <p>Thinking of implementing the LPMA logo on your site, social media or letterhead? Follow this quick guide for proper use cases.</p>
        <div className="image is-16by9">
      ...
      <div className="column is-4-desktop is-6-tablet is-12-mobile resource-item">
        ...
        <p>If you have any questions about this brand kit or how to use the LPMA member badge please contact us.</p>
