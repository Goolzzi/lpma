...
const Resources = () => (
  <section className="section resources">
    <p className="top-p">
      Stand out from the crowd and leverage our exclusive LPMA Member assets to
      differentiate your PM business from your competitors.
    </p>
    ...
    <div className="columns is-multiline">
      ...
      <div className="column is-4-desktop is-6-tablet is-12-mobile resource-item">
        ...
        <p>
          If you have any questions about this brand kit or how to use the LPMA
          member badge please contact us.
        </p>
